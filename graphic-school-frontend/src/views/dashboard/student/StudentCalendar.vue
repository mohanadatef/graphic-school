<template>
  <div class="space-y-6">
    <div>
      <h2 class="text-2xl font-bold text-slate-900 dark:text-white">{{ $t('student.calendar.title') || 'Calendar' }}</h2>
      <p class="text-sm text-slate-500 dark:text-slate-400">{{ $t('student.calendar.subtitle') || 'View your schedule and deadlines' }}</p>
    </div>
